...
public class PagerActivity extends AppCompatActivity implements
  ...
  @Inject
  CurrentQariBridge currentQariBridge;
  @Inject
  QuranEventLogger quranEventLogger;
  @Inject
  AudioStatusRepository audioStatusRepository;
  @Inject
  ReadingEventPresenter readingEventPresenter;
  @Inject
  PageViewFactoryProvider pageProviderFactoryProvider;
  @Inject
  Set<AyahActionFragmentProvider> additionalAyahPanels;
  @Inject
  PagerActivityRecitationPresenter pagerActivityRecitationPresenter;
  @Inject
...
//                    Toast.makeText(this, key, Toast.LENGTH_LONG).show();
  ...
  public void playWithNotification(){
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (itemId == R.id.favorite_item) {
      ...
      TimePickerDialog timePickerDialog = new TimePickerDialog(PagerActivity.this,
